...
if str(contract.get('contract_revision')) not in ('33','34','35','36','37'): errors.append('Backporter contract revision must be Pass 33 or a forward-compatible later fidelity revision')
